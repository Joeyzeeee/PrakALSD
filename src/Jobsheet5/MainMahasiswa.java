...
public class MainMahasiswa {
    public static void main(String[] args) {
        ...
        int maxUTS = Mahasiswa.nilaiMaxUTS(nilaiUTS, 0, data.length - 1);
        int minUTS = Mahasiswa.nilaiMinUTS(nilaiUTS, 0, data.length - 1);
        double rataUAS = Mahasiswa.hitungRataUAS(nilaiUAS);
